...
sl.markdown(f'''**Streamlit** is *really*
            ***cool***.
            <h2 class="card-text">_***{'01'}/{'02'}/{'03'}***_</h2>''')
sl.markdown('''
...
<h6 style ="color: #00eeff; ">Digite um número de 1 a {max}</h6>''', unsafe_allow_html=True)
# sl.markdown(f'''
...
sl.markdown(f'''
    <div class="card">
        <h3>Gabriel Sakura</h3>
        <img class="card-img-top" style="width: 10rem;" src="https://i.imgur.com/4lJxXwY.jpg" alt="Gabriel Sakura">
        <div class="card-body">
            <h5 class="card-title">Scrum Master</h5> <!-- Changed from </h3> to </h5> -->
            <h6 class="card-title">O responsável por grande parte da programação dos sensores</h6>
        </div>
    </div>
''', unsafe_allow_html=True)